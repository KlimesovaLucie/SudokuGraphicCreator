...
{
    public class SolveKillerTests
    {
        [Test]
        public void SolveKiller_OneSolution()
        {
            ...
            sudoku.Variants.Add(SudokuType.Killer);
            ...
            var cage = new Cage(SudokuElementType.Killer, positions);
            cage.Number = 14;
            SudokuStore.Instance.Sudoku.SudokuVariants.Add(cage);
        ...
        [Test]
        public void SolveKiller_ZeroSolution()
        {
            string inputString = "100000000000200810005103002020600003000800740000700005000502006000900170800000000";
            int[,] givenNumber = SudokuRulesUtilities.CreateArrayFromInputString(inputString, 9, 9);
            Sudoku sudoku = new Sudoku(9, 3, 3);
