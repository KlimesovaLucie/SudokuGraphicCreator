...
{
    public class SolveUntouchableTests
    {
        [Test]
        public void SolveUntouchable_OneSolution()
        {
            string inputString = "080107050740000093000090000200000009004000300800000006000030000620000031050706040";
            ...
            sudoku.Variants.Add(SudokuType.Untouchable);
            ...
            string solutionString = "983167254746825193512493867267384519194652378835971426471239685629548731358716942";
            Assert.That(SudokuRulesUtilities.CreateArrayFromInputString(solutionString, 9, 9), Is.EqualTo(solution));
        }

        [Test]
        public void SolveUntouchable_ZeroSolution()
        {
            string inputString = "080107650740000093000090000200000009004000300800000006000030000620000031050706040";
            int[,] givenNumber = SudokuRulesUtilities.CreateArrayFromInputString(inputString, 9, 9);
            Sudoku sudoku = new Sudoku(9, 3, 3);
            sudoku.GivenNumbers = givenNumber;
            sudoku.Variants.Add(SudokuType.Classic);
