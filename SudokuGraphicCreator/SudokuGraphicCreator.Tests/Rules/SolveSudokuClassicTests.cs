...
{
    public class SolveSudokuClassicTests
    {
        [Test]
        public void SolveClassic_OneSolution()
        {
        ...
        [Test]
        public void SolveClassic_ZeroSolution()
        {
            string inputString = "100000000700200810005103002020600003000800740000700005007502006000900170800000000";
            int[,] givenNumber = SudokuRulesUtilities.CreateArrayFromInputString(inputString, 9, 9);
            Sudoku sudoku = new Sudoku(9, 3, 3);
            sudoku.GivenNumbers = givenNumber;
            sudoku.Variants.Add(SudokuType.Classic);
        ...
        [Test]
        public void SolveClassic_MultipleSolution()
        {
            string inputString = "100000000000200810005103002020600003000800740000700005000502006000900070800000000";
            int[,] givenNumber = SudokuRulesUtilities.CreateArrayFromInputString(inputString, 9, 9);
            Sudoku sudoku = new Sudoku(9, 3, 3);
            sudoku.GivenNumbers = givenNumber;
            sudoku.Variants.Add(SudokuType.Classic);
