...
{
    /// <summary>
    /// ViewModel class for <see cref="GreyCircle"/> class.
    /// </summary>
    public class GreyCircleViewModel : CircleViewModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="GreyCircleViewModel"/> class.
        /// </summary>
        ...
        public GreyCircleViewModel(double width, double height, double left, double top, int rowIndex, int colIndex, SudokuElementType type, ElementLocationType location) :
            base(width, height, left, top)
        {
            var newElem = new GreyCircle(left, top, rowIndex, colIndex, type, location);
        ...
        {
            if (sudokuElement == SudokuElementType.Odd)
            {
                AddSudokuVariant(SudokuType.Odd);
            }
        }
        ...
        private void RemoveVariant(ObservableCollection<SudokuElementViewModel> collection, SudokuElementType sudokuType)
        {
            ...
            if (sudokuType == SudokuElementType.Odd)
            {
                SudokuStore.Instance.Sudoku.Variants.Remove(SudokuType.Odd);
            }
        }
        ...
        private int CountSameTypeElems(ObservableCollection<SudokuElementViewModel> collection, SudokuElementType elemType)
        {
            ...
            {
                var elem = item as GreyCircleViewModel;
